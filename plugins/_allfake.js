...
handler.all = async function(m) {
    ...
    try {
        ...
        global.kontak2 = [
            [owner[0], await conn.getName(owner[0] + '6283179789056@s.whatsapp.net'), 'Tio', 'https://whatsapp.com', true],
        ]
        ...
        global.fVerif = {
            key: {
                participant: '6283179789056@s.whatsapp.net',
                remoteJid: "6283179789056@s.whatsapp.net"
            },
            message: {
    ...
    global.adReply = {
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                "serverMessageId": 103,
                "newsletterName": `📡 ping : ${ms} × ⌜ Meebotz MD ⌟ © - Fauzan
                `
